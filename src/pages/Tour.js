...
const springTour = [
  ...
  {date: 'APR 18', venue: 'The Capitol Room at HMAC', city: 'Harrisburg, PA', ticketLink: 'https://www.bandsintown.com/e/1019185309-space-bacon-at-the-capitol-room-at-hmac?came_from=251&utm_medium=web&utm_source=artist_page&utm_campaign=ticket_rsvp'},
  ...
  {date: 'JUN 6', venue: 'Buffalo Iron Works', city: 'Buffalo, NY', ticketLink: 'https://www.bandsintown.com/e/102070484-space-bacon-at-buffalo-iron-works?came_from=251&utm_medium=web&utm_source=artist_page&utm_campaign=ticket_rsvp'},
      ...
      <div className={classes.tourCard}>
        <div className={classes.tourDateContainer}>
          <div className={classes.innerContainer}>
            <div className={`${classes.date} fontSize ${classes.tourInfo}`}>{date}</div>
            <div className={`${classes.venue} fontSize ${classes.tourInfo}`}>{venue}</div>
            <div className={`${classes.city} fontSize ${classes.tourInfo}`}>{city}</div>
          </div>
